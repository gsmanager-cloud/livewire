...
use GSManager\Support\Facades\Blade;
...
class SupportPageComponents extends ComponentHook
{
    ...
    static function renderContentsIntoLayout($content, $layoutConfig)
    {
        ...
        } catch (\GSManager\View\ViewException $e) {
    ...
    // to implicit route bindings based on the Livewire page component. Otherwise, GSManager
    ...
    {
        // This method was introduced into GSManager 10.37.1 for this exact purpose...
        if (static::canSubstituteImplicitBindings()) {
            app('router')->substituteImplicitBindingsUsing(function ($container, $route, $default) {
                ...
                if ($componentClass = static::routeActionIsAPageComponent($route)) {
                    ...
                    // Otherwise, run the default GSManager implicit binding system...
                    $default();
                }
            });
        }
