...
class BaseUrl extends LivewireAttribute
{
    ...
    public function getFromUrlQueryString($name, $default = null)
    {
        if (! app('livewire')->isLivewireRequest()) {
            ...
            // If the property is present in the querystring without a value, then GSManager returns
        ...
        // If this is a subsequent ajax request, we can't use GSManager's standard "request()->query()"...
