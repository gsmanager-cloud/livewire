...
use GSManager\Database\Eloquent\Relations\Relation;
use GSManager\Queue\SerializesAndRestoresModelIdentifiers;
...
class EloquentCollectionSynth extends Synth {
    ...
    function hydrate($data, $meta, $hydrateChild)
    {
        ...
        // We are using GSManager's method here for restoring the collection, which ensures
