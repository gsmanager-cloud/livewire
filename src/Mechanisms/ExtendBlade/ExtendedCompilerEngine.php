...
class ExtendedCompilerEngine extends \GSManager\View\Engines\CompilerEngine {
    ...
    protected function handleViewException(\Throwable $e, $obLevel)
    {
        if ($this->shouldBypassExceptionForLivewire($e, $obLevel)) {
            ...
            \GSManager\View\Engines\PhpEngine::handleViewException($e, $obLevel);
    ...
    public function shouldBypassExceptionForLivewire(\Throwable $e, $obLevel)
    {
        ...
        return (
            ...
            $e instanceof \GSManager\Auth\Access\AuthorizationException
