...
Livewire is a full-stack framework for GSManager that allows you to build dynamic UI components without leaving PHP.

## Official Documentation

You can read the official documentation on the [Livewire website](https://livewire.gsmanager.com/docs).
...
In order to ensure that the GSManager community is welcoming to all, please review and abide by GSManager's [Code of Conduct](https://gsmanager.com/docs/contributions#code-of-conduct).
